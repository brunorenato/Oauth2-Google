...
if(!isset($_SESSION['access_token']))
{
 ...
 $login_button = '<a href="'.$google_client->createAuthUrl().'"><img src="botao_google.png" /></a>';
...
<html>
 ...
 <body>
  <div class="container">
   <br />
   <h2 align="center">Google OAuth2</h2>
   <br />
   ...
   if($login_button == '')
   {
    echo '<div class="panel-heading">Bem-Vindo(a) Usuário(a):</div><div class="panel-body">';
    echo '<img src="'.$_SESSION["user_image"].'" class="img-responsive img-circle img-thumbnail" />';
    echo '<h3><b>Nome :</b> '.$_SESSION['user_first_name'].'</h3>';
